...
//	private boolean isLoadMoreable;
	private boolean isLoadedMore,canLoadMore;
	...
	{
        canLoadMore=false;
		sp = context.getSharedPreferences("refreshInfo", Context.MODE_WORLD_READABLE);
			...
			int visibleItemCount, int totalItemCount)
	{
		...
		if(canLoadMore&&(totalItemCount-firstVisibleItem<visibleItemCount+5))
		{
			//need to load more
			if(isLoadedMore)
			{
...
//		System.out.println("firstVisibleItem "+firstVisibleItem+" totalItemCount "+totalItemCount+" visibleItemCount "+visibleItemCount);
	...
	private void changeHeaderViewByState()
	{
		switch (state)
		{
			...
			case DONE:
				...
				lvHeaderProgressBar.setVisibility(View.GONE);
				lvHeaderArrowIv.clearAnimation();
				lvHeaderArrowIv.setImageResource(R.drawable.default_indicator_arrow);
				lvHeaderTipsTv.setText("下拉刷新");
				lvHeaderLastUpdatedTv.setVisibility(View.VISIBLE);
				break;
		}
